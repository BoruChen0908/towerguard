...
// ---- airport code: set once from first event that carries it ----
let airportSet = false;
function maybeSetAirport(code) {
  if (!airportSet && code) {
    airportCodeEl.textContent = code;
    airportSet = true;
  }
}
